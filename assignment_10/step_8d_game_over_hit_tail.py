# Stockdale Assignment 10 – Step 8d
# Add game over condition when snake hits its own tail,
# and restart functionality via pressing SPACE.
...
class Game:
    ...
    def check_collision_with_tail(self):
        head = self.snake.body[0]
        # Check if head collides with any other part of body
