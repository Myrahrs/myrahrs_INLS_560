# Stockdale Assignment 10 – Step 8c
# Add restart functionality after game over via pressing SPACE.
...
font = pygame.font.SysFont(None, 48)  # For displaying messages
...
class Game:
    def __init__(self):
        self.snake = Snake()
        self.food = Food()
        self.state = "RUNNING"  # RUNNING or STOPPED
    ...
    def draw(self, surf):
        ...
        if self.state == "STOPPED":
            self.draw_game_over_message(surf)

    def draw_game_over_message(self, surf):
